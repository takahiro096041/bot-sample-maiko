  ...
  switch (incident.message.text) {
    case '何か飲みたい':
      { // case内で変数宣言するといいは {} で囲ったほうがいいらしい
        ...
        buttons.setMessage('ええどすえ。どちらがご希望どすか〜？');
    ...
    case '触らせてよ':
      osawari.handle(incident);
      return;
    default:
    　var textMessageBuilder = new LINEBot.TextMessageBuilder('わかりまへんわ！京都弁話しなはれ！');
